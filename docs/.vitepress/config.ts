      ...
      nav: [
        ...
        { text: "Tài liệu", link: "/vi/" },
        {
          ...
          items: [
            ...
            { text: "Hàng đợi xử lý", link: "/tasks/jobs" },
            { text: "Quản lý mô hình", link: "/tasks/models" },
          ],
        },
