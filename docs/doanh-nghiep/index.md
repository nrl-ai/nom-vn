...
<a href="/screenshots/19-compliance-high-risk.png" target="_blank" rel="noopener">
<img src="/screenshots/19-compliance-high-risk.png" alt="Phân loại rủi ro theo Luật 134/2025 — kết quả 'Rủi ro cao' với năm lý do tham chiếu các điều luật cụ thể." loading="lazy" />
</a>
<figcaption>
...
<figure class="ev-screen">
<a href="/screenshots/20-admin-ee-license.png" target="_blank" rel="noopener">
<img src="/screenshots/20-admin-ee-license.png" alt="Trang quản trị doanh nghiệp hiển thị tên khách hàng, hạn dùng, danh sách tính năng đang bật và 16 mục nhật ký kiểm toán có băm SHA-256." loading="lazy" />
</a>
<figcaption>
...
<figure class="ev-screen">
<a href="/screenshots/18-agent-run-live.png" target="_blank" rel="noopener">
<img src="/screenshots/18-agent-run-live.png" alt="Trình chạy tác tử hiển thị 20 sự kiện theo thời gian thực — bắt đầu, suy luận, gọi công cụ detect_language và extract_entities, kết quả thực thể." loading="lazy" />
</a>
<figcaption>
